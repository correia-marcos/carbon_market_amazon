...
# =============================================================================
# @Goal: Estimate synthetic controls for the buffer region (leakage)
# 
...
create_treatment_dfs(final_buffer, additional = TRUE)
...
for (i in seq_along(plot_subgroups)) {
  ...
  # Salve in pdf
  ggsave(paste0("results/synthetic_controls/group_", i, "_buffer.pdf"),
         combined_plot, width = 30, height = 20, dpi = 300)}


# Salve each plots as PDF
for(plot_name in plot_names) {
  plot_path <- paste0(here::here("results", "synthetic_controls"), "/", plot_name, 
                      "_buffer.pdf")
  print(plot_path)
